...
function getStyleDato(tipodato) {
    return function(feature) {
        ...
        switch (tipodato) {
            ...
            case 'promEsco':
                const escolaridad = properties.edu_pesco; 
                if (escolaridad <= 6) {
                    color = '#BC4516'; // Clase 1 8A2C0C
                } else if (escolaridad <= 9) {
                    color = '#F09D7C'; // Clase 2 C54717
                } else if (escolaridad <= 12) {
                    color = '#F6C7B4'; // Clase 3 E25A38
                } else if (escolaridad <= 16) {
                    color = '#FDF2ED'; // Clase 4 EB7E5F
                }
        ...
        case 'pobmuntot':
            ...
            case 'promEsco':
                legendConfig = {
                    ...
                    style: [
                        { label: '≤ 6 años', color: '#BC4516' }, // Clase 1
                        { label: '6 - 9 años', color: '#F09D7C' }, // Clase 2
                        { label: '9 - 12 años', color: '#F6C7B4' }, // Clase 3
                        { label: 'Mas de 12 años', color: '#FDF2ED' }, // Clase 4
                    ]
                }
                break;
    }
